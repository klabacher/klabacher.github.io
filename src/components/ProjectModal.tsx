        ...
        <div className="overflow-y-auto custom-scrollbar flex-1">
          <div className="grid grid-cols-1 lg:grid-cols-12 min-h-full">
            ...
            <div className="lg:col-span-7 bg-black/20 p-6 lg:p-10 flex flex-col justify-center">
              {/* Imagem Principal */}
              <div className="relative aspect-video rounded-xl overflow-hidden border border-white/10 shadow-lg group">
                <img
                ...
                <div className="absolute bottom-0 left-0 right-0 p-4 bg-linear-to-t from-black/90 via-black/60 to-transparent translate-y-full group-hover:translate-y-0 transition-transform duration-300">
            ...
            <div className="lg:col-span-5 p-8 lg:p-10 bg-[#141414] flex flex-col border-l border-white/5">
              ...
              <div className="mb-6">
                ...
                <p className="text-gray-400 text-lg leading-relaxed">{project.shortDescription}</p>
              </div>
